...
declare module Tee {
    ...
    interface ISeriesNoBounds {
        ...
        valueFormat: string;
        markPos(index: number, point: Point): Point;
        legend: ISeriesLegend;
    }
    ...
    var Annotation: {
        prototype: IAnnotation;
        new (chart?: Chart): IAnnotation;

    }

    var Format: {
        prototype: IFormat;
        new (values?: number[]): IFormat;
    }
}
